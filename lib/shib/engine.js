...
var Engine = exports.Engine = function(label, executer_conf, monitor_conf, query_timeout) {
...
Engine.prototype.databases = function(callback){
  if (this.supports('databases')) {
    this._executer.databases(function(err, dbnamelist){
      ...
      for (var i = 0 ; i < len ; i++) {
        if (dbnamelist[i] === this.default_dbname) {
          dbnamelist.splice(i);
          break;
        }
      }
      dbnamelist.unshift(this.default_dbname);
