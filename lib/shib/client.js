...
//TODO: fix caller (list is of Query instances)
...
//TOOD: addRecent is not needed now
//TODO: deleteRecent is not needed now
...
//TODO: remove getResult & .result -> updateQuery
//TODO: remove getResults & .results
...
//TODO: remove getLastResult -> query.result

//TODO: client.status(query, callback) -> query.state
...
Client.prototype.execute = function(query, args){
  ...
  engine.execute(query.queryid, query.dbname, query.composed(), {
    ...
    schema: function(error, data){
      ...
      schemaRow = data.schema.map(function(f){return f.name.toUpperCase();}).join('\t');
    },
