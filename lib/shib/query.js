...
var Query = exports.Query = function(args){
  ...
  this.queryid = args.queryid || Query.generateQueryId(this.querystring, this.keywords, args.seed);
};
...
Query.generateQueryId = function(querystring, keywords, seed){
  if (!seed)
    seed = '';
  var md5sum = crypto.createHash('md5');
  md5sum.update(new Buffer(querystring + ';' + keywords.join(",") + seed, 'utf8'));
