...
/*
  var options = { host: "master201.analysis", port: 50030, path: '/jobdetails.jsp?jobid=job_201405091635_27267', method: 'GET' };
  var options = { host: "master201.analysis", port: 50030, path: '/jobtracker.jsp', method: 'GET' };
  var cb = function(res){
    res.setEncoding('utf8');
    res.on('data', function(chunk){
      html += chunk;
