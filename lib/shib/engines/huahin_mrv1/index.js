...
function convertStatus(status) {
  ...
  */
  ...
  retval['jobid'] = data['jobid'];
  retval['name'] = data['name'];
  retval['priority'] = data['priority'];
  retval['state'] = data['state'];
  retval['trackingURL'] = data['trackingURL'];
  ...
  retval['mapComplete'] = (data['mapComplete'] ? parseInt(data['mapComplete']) : null);
  retval['reduceComplete'] = (data['reduceComplete'] ? parseInt(data['reduceComplete']) : null);
...
Monitor.prototype.kill = function(jobid, jobname, callback){
